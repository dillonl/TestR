...
namespace rufus
{
	...
	public:
		...
		static inline bool ParseAlignment(const char* alignment, size_t alignmentLength, InternalKmer& internalKmer)
		{
			uint64_t shifter1 = 1;
			uint64_t shifter3 = 3;
			internalKmer = 0; // we must guarentee internalKmer is zero
